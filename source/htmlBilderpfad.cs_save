  ...
  public static string PfadArbeiten(string pfad)
  {
    ...
    if (StartFenster.Plattform == 0) /* Windows  */
    {
      ...
      if (!istBaukastenBild)
      {
        ...
        {
          pfad = StartFenster.CopyImagesBool ? @"../../Bilder/" + newpfad : @"file:///" + oldpfad;
        }
    ...
    if (StartFenster.Plattform == 1)/* Linux */
    {
      if (!istBaukastenBild)
      {
        ...
        if (StartFenster.CopyImagesBool) /* kopiere! */
        {
          // Linux: Kopiert die Originalbilder ins Fotoalbum:
          zwischenstring = @"Fotoalben/" + StartFenster.Albumname + "/Bilder/";
          pfad = newpfad;
        }
        else                             /* nicht kopieren! */
        {
