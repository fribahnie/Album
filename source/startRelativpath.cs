	...
	*/
		...
		*/
		...
		public static void RelativePfade()
		{
			...
			string s1;
			// Der Normalfall:
			s1 = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile);
			string value = StartFenster.Plattform == 1 ? "Pictures" : "MyPictures";
			s1 += sep + value;
			Console.WriteLine("Als Pfad erkannt: {0}", s1);
